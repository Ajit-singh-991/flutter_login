...
import 'package:flutter_login/pages/bitcoin.dart';
import 'package:flutter_login/pages/dogs.dart';
                            ...
                            VStack([
                              Center(
                                child: ElevatedButton(
                                  ...
                                  onPressed: (){
                                  Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context)=>const Dogs()),
                                  );
                                },
                                 child: const Text("Dogs detail")),
                              )
                            ]),
                          ]).px64().px64(),
                            ]).px12(),
